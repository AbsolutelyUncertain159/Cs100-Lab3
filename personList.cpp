...
PersonList::~PersonList(){
    for (int i = 0; i < numPeople; i++) //going through the amount of peopel
    {
        delete theList[i]; //deleteing the current iteration of the list
    }
    delete[] theList; //deallocating theList
}
